...
test("the standalone top-of-feed comparison section is gone", () => {
  ...
  // COMM-115 added the club strip above the announcements. The assertion
  // that matters here is unchanged: `comparison` is not one of the parts the
  // Feed sub-tab is built from any more.
  assert.match(cloudJs, /const feedTab = clubTopHtml \+ announcementsHtml \+ feedHtml;/);
});
