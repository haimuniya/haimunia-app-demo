...
You can use the service anonymously or with a member handle and password.
...
- Harass, threaten, or impersonate another member or staff.
- Post spam, or content that is unlawful, dangerous, or infringes someone
  else's rights.
- Attempt to circumvent invite limits, rate limits, or any privacy or
  access control the app enforces.
- Access or attempt to access another member's data outside what their own
  privacy settings and the app's features allow.
...
We may review reported content, restrict a specific post or comment while
it is under review, and restrict or suspend an account for violating these
terms, without prior notice where we reasonably believe it is necessary to
protect other members or the service. You can remove your own posts,
comments, and follows, block other members, and report content you believe
violates these terms at any time.

## Not medical or professional advice

Workout results, scores, and comparisons in the app are user-provided and
are not medical advice, a certified competition result, or a substitute for
guidance from a qualified coach or medical professional. Consult a
qualified professional before beginning any exercise program, and use your
own judgment about your physical limits.
...
required, an in-app notice. Continuing to use the service after a change
